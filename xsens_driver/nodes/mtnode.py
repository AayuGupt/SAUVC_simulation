...
class XSensDriver(object):
    ...
    def spin_once(self):
        ...
        def convert_quat(q, source, dest=self.frame_local):
            ...
            q_enu_nwu = (1./sqrt(2), 0, 0, old_div(-1.,sqrt(2)))
            q_ned_nwu = (0, -1, 0, 0)
            q_ned_enu = (0, old_div(-1.,sqrt(2)), old_div(-1.,sqrt(2)), 0)
        ...
        def fill_from_Timestamp(o):
            ...
            try:
                ...
                # int in 10kHz ticks
                secs = int(old_div(sample_time_fine, 10000))
        ...
        def fill_from_GNSS(o):
            ...
            try:  # PVT
                ...
                self.raw_gps_msg.altitude = old_div(o['height'],1e3)
