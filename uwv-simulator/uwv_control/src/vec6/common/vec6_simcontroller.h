#ifndef VEC6_SIMCONTROLLER_H
#define VEC6_SIMCONTROLLER_H
...
class Vec6SimController : public Vec6Controller{
...
public:
	...
	void allThrustersStop(void) override;
		...
		//void allThrustersStart(void) override;
